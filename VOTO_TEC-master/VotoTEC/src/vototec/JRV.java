...
public class JRV {
    ...
    */
    ...
    private ArrayList<RegistroDeVotos> registroDeVotos = new ArrayList();
    ...
    public ArrayList<RegistroDeVotos> getRegistroDeVotos() {
        return registroDeVotos;
    }

    public void setRegistroDeVotos(RegistroDeVotos r) {
        this.registroDeVotos.add(r);
    }
